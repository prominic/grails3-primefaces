...
class Grails3PrimefacesGrailsPlugin extends Plugin  {
    ...
    def title = "grails3-primefaces" // Headline display name of the plugin
...
//    def scm = [ url: "http://svn.codehaus.org/grails-plugins/" ]
    ...
    Closure doWithSpring() { {->
        ...
        println "doWithSpring work main"



        grails3PrimefacesConfig(Grails3PrimefacesConfig)
        ...
        //localeResolver(SpringBeanFacesELResolver)
    ...
    def doWithWebDescriptor = { xml ->
        ...
        println "doWithWebDescriptor work"
